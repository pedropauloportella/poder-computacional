...
sections.forEach((sec) => {
    ...
    revealUptimeline.to(sec.querySelectorAll(".reveal-up"), {opacity: 1, duration: 0.8, y: "0%", stagger: 0.2})
})

// Poder Computacional: connect the existing Solutions menu item to the SEO landing page.
document.querySelectorAll(".header-links").forEach((link) => {
    if (link.textContent.trim().toLowerCase() === "solutions") link.href = "./solucoes.html"
})
